...
def genotype(features,out,classifier_name,Ped,Conf,gen):
	...
	ofh = open(out,'w')
	ofh.write('\t'.join(('#CHROM','START','END','TYPE','LENGTH','ID','COVERAGE','DISCORDANT_PAIRED-END','SPLIT_READS','SNV_COVERAGE','SNVs','HETEROZYGOUS_ALLELIC_DEPTH','HETEROZYGOUS_SNVs','COPY_NUMBER_GENOTYPE','REF_GENOTYPE_LIKELIHOOD','HET_GENOTYPE_LIKELIHOOD','HOM_GENOTYPE_LIKELIHOOD','ALT_GENOTYPE_LIKELIHOOD','REF_QUAL','ALT_QUAL','CLASSIFIER'))+'\n')
